...
function Word({ x, y = 24, size = 15, spacing = 1.4, weight = 700, children, fill = "currentColor" }: WordProps) {
  return (
    <text
      x={x}
      y={y}
...
export const BRAND_LOGOS: readonly { id: string; Logo: ComponentType }[] = [
